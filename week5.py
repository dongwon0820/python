...
what = input("좋아하는 과일입력:")

fruit =["바나나","사과","멜론","수박","배","귤"]
fruit .append(what)
...
## 연습문제>> 아쉽지만(ㅎㅎ) 선생님이 추가한유투버를 리스트에서 삭제해보자.
#<명령입력>
del fruit[2]
print("사과")
...
##pull_up = [3, 16, 2, 5, 10, 7] 1번 문제: 7번째 학생의 턱걸이 개수가 9라고 할 때, 이를 리스트에 추가해보자
pull_up.append(9)
print(pull_up)
''''
'''
## 2번 문제: 2번 학생의 결과 20개의 턱걸이를 하였다. 리스트에 데이터를 수정해보자
<명령입력>
print(pull_up)
